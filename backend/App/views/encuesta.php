                                                                                ...
                                                                                <li class="mt-4">
                                                                                    ...
                                                                                    <div class="row mt-4 d-flex text-center">
                                                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 d-flex align-items-stretch justify-content-center">
                                                                                            ...
                                                                                            <label class="btn btn-lg btn-outline-secondary border-2 px-2 py-2 w-100" for="btncheck144">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 d-flex align-items-stretch justify-content-center">
                                                                                            ...
                                                                                            <label class="btn btn-lg btn-outline-secondary border-2 px-2 py-2 w-100" for="btncheck145">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 d-flex align-items-stretch justify-content-center">
                                                                                            ...
                                                                                            <label class="btn btn-lg btn-outline-secondary border-2 px-2 py-2 w-100" for="btncheck146">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 d-flex align-items-stretch justify-content-center">
                                                                                            ...
                                                                                            <label class="btn btn-lg btn-outline-secondary border-2 px-2 py-2 w-100" for="btncheck147">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 d-flex align-items-stretch justify-content-center">
                                                                                            ...
                                                                                            <label class="btn btn-lg btn-outline-secondary border-2 px-2 py-2 w-100" for="btncheck152">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 d-flex align-items-stretch justify-content-center">
                                                                                            ...
                                                                                            <label class="btn btn-lg btn-outline-secondary border-2 px-2 py-2 w-100" for="btncheck153">
